...
@section('title', 'Create Assignment · ' . $course->name)
    ...
    <section>
        ...
        <div class="mt-6">
            ...
            <p class="mt-2 text-slate-500">
                Create an assignment for your students with instructions,
                marks, deadlines and submission rules.
            </p>
        </div>
    </section>
    ...
    >
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Give students a clear title and define what they need to complete.
                </p>
            </div>
            ...
            <div class="space-y-6 p-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        maxlength="255"
                        placeholder="e.g. Algebraic Expressions Practice"
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-slate-400">
                        This appears as a short summary before students open the assignment.
                    </p>
                </div>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Explain exactly what students should do.
                </p>
            </div>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Set marks, deadlines and what students can do after submitting.
                </p>
            </div>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-slate-500">
                            The maximum score students can receive.
                        </p>
                    </div>
                ...
                <div class="border-t border-slate-100 pt-6">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <input
                            ...
                            type="checkbox"
                            value="1"
                            @checked(old('allow_late_submission', false))
                    ...
                    <div
                        ...
                        class="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-5 {{ old('allow_late_submission', false) ? '' : 'hidden' }}"
                    >
                ...
                <div class="border-t border-slate-100 pt-6">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <input
                            ...
                            type="checkbox"
                            value="1"
                            @checked(old('allow_resubmission', false))
                            class="mt-1 h-4 w-4 rounded border-slate-300 text-slate-900 focus:ring-slate-300"
                        >
                    ...
                    <div
                        ...
                        class="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-5 {{ old('allow_resubmission', false) ? '' : 'hidden' }}"
                    >
                        ...
                        <p class="mt-2 text-xs text-slate-500">
                            ...
                            For example, 3 attempts means the student can submit
                            initially and resubmit twice.
                        </p>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm leading-6 text-blue-800">
                                The normal due date determines when an assignment
                                becomes late. If late submissions are enabled,
                                students can continue submitting according to
                                the late deadline. If resubmissions are enabled,
                                students can create additional attempts up to
        ...
        <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-100 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Add supporting files such as worksheets, PDFs or reference documents.
                </p>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    name="save_action"
                    value="draft"
                    class="rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50"
                >
                    Save Draft
                </button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const lateCheckbox = document.getElementById('allow_late_submission');
    const lateSettings = document.getElementById('late-submission-settings');
    const lateDeadline = document.getElementById('late_submission_until');
    ...
    function updateResubmissionSettings() {
        ...
        resubmissionSettings.classList.toggle('hidden', !enabled);
     ...
     * =============================================================
     *
     * Make sure the Tiptap editor content is copied into the hidden
     * instructions textarea before the form is submitted.
     *
     * The actual Tiptap editor script may already handle this.
     * This listener safely handles the hidden field if the editor
     * exposes its instance globally.
     */
